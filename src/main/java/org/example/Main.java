...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            /*CARGAMOS OBJETOS DE CADA ENTIDAD*/
            ...
            Domicilio domicilio1 = Domicilio.builder().nombreCalle("Gorriti").numero(1415).build();

            Cliente cliente1 = Cliente.builder().nombre("Emiliano").apellido("Jordan").dni(45255537).domicilio(domicilio1).build();
            ...
            /*MODIFICAMOS EL NUMERO DEL FACTURA CREADA ANTERIORMENTE*/
            entityManager.getTransaction().begin();
            factura1.setNumero(2527);
            entityManager.getTransaction().commit();
